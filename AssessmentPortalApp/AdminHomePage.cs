...
namespace AssessmentPortalApp
{
    public partial class AdminHomePage : Form
    {
        ...
        private void AdminHomePage_Load(object sender, EventArgs e)
        {
            ...
            timer1.Interval = 1500;  // Blink every half second
            timer1.Enabled = true;  // Start the timer
        }

        private void timer1_Tick(object sender, EventArgs e)
        {
            // Assuming 'panel1' is the panel you want to blink
        ...
        private void timer1_Tick_1(object sender, EventArgs e)
        {
            if (isColored)
            {
                panel1.BackColor = SystemColors.Control; // Original color
            }
            else
            {
                panel1.BackColor = Color.LightPink; // Blink color
            }
            isColored = !isColored;
        }
