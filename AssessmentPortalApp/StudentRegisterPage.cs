...
namespace AssessmentPortalApp
{
    public partial class StudentRegisterPage : Form
    {
        ...
        public bool ValidateFields()
        {
            ...
            if (cmbRole.SelectedIndex == 0) // 0 is "Select Role"
            {
        ...
        private void LoadRoles()
        {
            ...
            using (SqlDataAdapter adapter = new SqlDataAdapter(query, con))
            {
                ...
                // Insert a default item at the beginning of the DataTable
                DataRow defaultRow = rolesTable.NewRow();
                defaultRow["RoleId"] = 0; // or any invalid RoleId if 0 is used
                ...
                // Set the default selected index to 0 (Select Role)
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            using (SqlCommand cmd = new SqlCommand(query, con))
            {
                ...
                try
                {
                    ...
                    lblId.Text = $"{userId}";
                    MessageBox.Show("Student data saved successfully.", "Registration Successful", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void ClearFields()
        {
            ...
            cmbRole.SelectedIndex = 0; // Set to default role
